...
int pritn_percent(va_list types, char buffer[], int flags, int width, int precision, int size);
...
int unsignd(int is_negative, int ind, char buffer[], int flags, int width, int precision, int size);

/********** UTILS **********/
int is_predictable(char);
int append_hexa_code(char, char[], int);
int is_digit(char);

long int convert_size_number(long int num, int size);
lonh int cinvert_size_unsgnd(unsigned long int num, int size);
